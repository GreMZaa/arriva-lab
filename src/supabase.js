...
export const defaultProducts = [
  {
    id: 1,
    name: "АРХИВ 002",
    subtitle: "Быстрый старт (Сами)",
    price: 14900,
    type: "basic",
    description: "Быстрый старт (Сами)",
    features: [
  ...
  },
  {
    ...
    subtitle: "Переход с веб-камеры (Рестарт)",
    price: 29900,
    type: "restart",
    description: "Переход с веб-камеры на VTuber формат",
    features: [
  ...
  },
  {
    ...
    subtitle: "Полное сопровождение под ключ",
    price: 39900,
    type: "premium",
    description: "Полное сопровождение под ключ (С нами)",
    features: [
  ...
  },
  {
    id: 5,
    name: "АРХИВ 003",
    subtitle: "Всё включено (С нами)",
    price: 35900,
    type: "18+",
    description: "Всё включено (С нами) — спец. площадки & анонимность",
    features: [
  ...
  },
  {
    ...
    subtitle: "Агентская программа сопровождения",
    price: 0,
