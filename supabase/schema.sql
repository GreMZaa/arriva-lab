...
('Создание 2D модели', 0.00, 'service_2d', 'Цена по запросу', 'Разработка концепт-арта персонажа, арт по слоям и профессиональный Live2D риггинг',
 '["Концепт-арт персонажа", "Рисование по слоям под Live2D", "Профессиональный Live2D риггинг", "Калибровка отслеживания лица"]'::jsonb),
('Создание 3D модели', 0.00, 'service_3d', 'Цена по запросу', 'Трехмерное моделирование персонажа, текстурирование, настройка шейдеров и физики под VRM/Unity',
 '["3D Моделирование персонажа", "Текстурирование и шейдеры", "Настройка костей и физики", "Экспорт в VRM / Unity"]'::jsonb),
('Аудио переводчик', 10000.00, 'audio_translator', 'На один язык', 'Выкуп своего голоса, настройка на один язык для потокового аудио-перевода',
 '["Клонирование/выкуп своего голоса", "Настройка автоперевода на 1 язык", "Интеграция с софтом трансляции", "Минимальная задержка звука"]'::jsonb)
