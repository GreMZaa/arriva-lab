...
bot.callbackQuery("prices", async (ctx) => {
  const priceText = `💎 <b>Наши тарифы и экосистема Oriva Lab</b>\n\n` +
    ...
    `<i>Базовый архив + разработка 2D-аватара со скидкой 50%.</i>\n\n` +
    `🔵 <b>АРХИВ 002 + 3D</b> — <code>34 900 ₽</code>\n` +
    `<i>Базовый архив + создание 3D/VRM модели со скидкой 50%.</i>\n\n` +
    `🟣 <b>АРХИВ 002 PREMIUM — Всё включено</b> — <code>39 900 ₽</code>\n` +
    `<i>Личное сопровождение под ключ + 2D или 3D модель в подарок.</i>\n\n` +
    `🔞 <b>АРХИВ 003 — Всё включено (С нами)</b> — <code>35 900 ₽</code>\n` +
    `<i>Запуск на 18+ и анонимных площадках с соблюдением полной приватности.</i>\n\n` +
    `🔄 <b>АРХИВ 004 — РЕСТАРТ</b> — <code>29 900 ₽</code>\n` +
    `<i>Переход с веб-камеры на VTuber формат без потери зрителей.</i>\n\n` +
